...
def fileupload(instance, filename):
    ...
    return "/".join(["student", new_file_name])
...
class StudyPlan(models.Model):
    program = models.ForeignKey(
        Program, on_delete=models.CASCADE, related_name="study_plans"
    )
...
class Equivalence(models.Model):
    destination_university = models.ForeignKey(
        University, on_delete=models.CASCADE, related_name="equivalences_destination"
    )
    ...
    origin_university = models.ForeignKey(
        University, on_delete=models.CASCADE, related_name="equivalences_origin"
    )
